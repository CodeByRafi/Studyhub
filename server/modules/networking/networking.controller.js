...
const { getImageUrl } = require('../../config/file-url-helper');
...
exports.createOrUpdateProfile = async (req, res) => {
  ...
  if (req.files) {
    if (req.files.profile_photo) {
      profile_photo_url = getImageUrl(req.files.profile_photo[0], 'profiles');
    }
    if (req.files.cover_photo) {
      cover_photo_url = getImageUrl(req.files.cover_photo[0], 'profiles');
    }
  }
