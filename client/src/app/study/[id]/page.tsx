    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f] text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/70">Loading study material...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f] text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/60 mb-6">The study material you're looking for doesn't exist or has been removed.</p>
          <Link
            href="/study"
        ...
        <div className="mb-8 rounded-xl border border-white/10 bg-gradient-to-br from-white/5 to-white/10 p-8 backdrop-blur-xl">
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1">
              <h1 className="text-4xl font-bold mb-3 leading-tight">{note.title}</h1>
              <div className="flex items-center gap-4 text-white/70 mb-4">
                <div className="flex items-center gap-2">
                  <span className="text-purple-400">👤</span>
                  <span>by {note.first_name} {note.last_name}</span>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 text-sm text-white/60">
                ...
                <span className="px-3 py-1 rounded-full bg-pink-500/20 text-pink-300 border border-pink-500/30">
                  {note.course_name}
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-2xl font-bold">{note.average_rating || "0"}</span>
                </div>
                <span className="text-white/60 text-sm">
                  ({note.rating_count || 0} {note.rating_count === 1 ? "rating" : "ratings"})
                </span>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="mb-8 rounded-xl border border-white/10 bg-gradient-to-br from-white/5 to-white/10 p-6 backdrop-blur-xl">
          ...
          {user ? (
            <div className="space-y-4">
              <p className="text-white/70">Click on a star to rate this material:</p>
            ...
            <div className="text-center py-6">
              ...
              <p className="text-white/60 mb-4">
                Please sign in to rate and review study materials
              </p>
            ...
            <div className="mb-8 rounded-lg border border-white/10 bg-white/5 p-6">
              ...
              <form onSubmit={handleAddComment} className="space-y-4">
                <textarea
                  ...
                  placeholder="Share your thoughts about this study material..."
          ...
          {!user && (
            <div className="mb-8 rounded-lg border border-blue-500/30 bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-6">
              ...
              <p className="text-white/80 mb-4">
                Sign in to share your thoughts and help other students with comments and ratings.
              </p>
          ...
          {commentsLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-white/60">
                Be the first to share your thoughts about this study material!
              </p>
            </div>
          ) : (
            <div className="space-y-4">
