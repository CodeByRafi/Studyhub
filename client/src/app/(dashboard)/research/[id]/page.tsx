          ...
          <div className="flex items-start justify-between mb-6">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {research.department_name && (
                  <span className="px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-widest bg-purple-500/10 text-purple-400 border border-purple-500/20">
                    {research.department_name}
                  </span>
                )}
                {research.course_name && (
                  <span className="px-3 py-1.5 rounded-lg text-xs font-black uppercase tracking-widest bg-white/5 border border-white/10 text-white/70">
                    {research.course_name}
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4 text-white/70 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span>by {research.first_name || 'Anonymous'} {research.last_name || 'Scholar'}</span>
                </div>
                <div className="flex items-center gap-2">
